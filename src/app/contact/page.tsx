		...
		<div className="max-w-2xl mx-auto py-12 bg-white shadow-lg rounded-lg overflow-hidden">
			<div className="px-4 py-6">
				...
				<ul className="mt-6 flex flex-col md:flex-row justify-center align-middle">
					...
					<div className="mx-7">
						<li className="flex items-center py-2 transform transition-transform hover:scale-105 cursor-pointer">
							<svg
							...
							<span className="text-gray-600">https://github.com/Sam-T-G</span>
						</li>
						<li className="flex items-center py-2 transform transition-transform hover:scale-105 cursor-pointer">
							<svg
								className="w-6 h-6 ml-1 mr-4"
						...
						<li className="flex items-center py-2 transform transition-transform hover:scale-105 cursor-pointer">
							...
							<span className="text-gray-600">@samuel_gerungan</span>
						</li>
					</div>
				</ul>
			</div>
